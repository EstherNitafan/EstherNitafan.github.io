...
// Update time
  function update() {
    ...
    function checkHalfMinute(momentMinute){
      if(momentMinute < 8) {halfMinute = 'Chakra1';}
      else if(momentMinute < 16){halfMinute = 'Chakra2';}
      else if(momentMinute < 24){halfMinute = 'Chakra3';}
      else if(momentMinute < 32){halfMinute = 'Chakra4';}
      else if(momentMinute < 40){halfMinute = 'Chakra5';}
      else if(momentMinute < 48){halfMinute = 'Chakra6';}
      else {halfMinute = 'Chakra7';}
    }
